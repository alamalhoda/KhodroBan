...
6. همیشه در پیشنهاد merge مشخص کن مقصد کدام branch است.
...
## قاعده Merge (خیلی مهم)
- branch فعلی = مقصد merge
- branchی که بعد از `git merge` می‌آید = منبع
