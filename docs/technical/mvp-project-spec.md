# دستور ساخت فنی (Project Spec) برای MVP OilChenger
...
- **نام محصول در ریپو**: OilChenger
- **نام‌های پیشنهادی برند** (اختیاری): «خودروبان» (Khodroban)

> نکته: در این ریپو و APIها، نام پایه را **OilChenger** نگه می‌داریم تا با اسناد موجود و ساختار پروژه هم‌خوان بماند. نام برند را بعداً می‌توان تغییر داد.

---

## 2) توضیح محصول (MVP)

OilChenger یک وب‌اپلیکیشن واکنش‌گرا (Mobile-First) برای مالکان خودرو در ایران است که:
